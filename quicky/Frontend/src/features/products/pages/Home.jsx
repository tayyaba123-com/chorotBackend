    ...
    return (
        <div className="group relative">
            ...
            <div className="relative w-full aspect-[3/4] bg-slate-100 rounded-2xl overflow-hidden mb-4 border border-slate-200 group-hover:border-[#f97316]/30 transition-colors">
                ...
                {/* Quick Add Button */}
                <Link to={`/product/${product._id}`} className="absolute inset-x-4 bottom-4 translate-y-12 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 z-30">
