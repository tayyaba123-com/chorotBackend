            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 xl:p-24 bg-white relative shadow-[-20px_0_40px_-15px_rgba(0,0,0,0.05)] z-20">
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className="text-center lg:text-left">
                        ...
                        <h2 className="text-3xl font-bold text-slate-800 tracking-tight">Login in</h2>
                        <p className="text-slate-500 mt-2">Sign in to get started</p>
                    </div>
                    ...
                    <p className="text-center text-sm text-slate-500 mt-8" >
                        Don't have an account? <a href="#" className="font-semibold text-indigo-600 hover:text-indigo-500">Register</a>
                    </p>
